  ...
  <div class="content title-page">
    <div class="content-body">
      <div class="content-header">
        <h5 class="text-center">Стандартная счет-фактура для плательщиков акциозного налога</h5>
      </div>
      <div class="table-body">
        <div class="ml-3 mr-3" id="invoice">
          <b-container>
            <b-row class="justify-content-md-center">
              <table class="properties">
                ...
                <tr>
                  <td>К товарно-отгрузочным документам №</td>
                  <td><input type="text" class="form-control form-control-sm"></td>
                  <td>Дата</td>
                  <td><input type="text" class="form-control form-control-sm"></td>
                </tr>
            ...
            <b-row>
              <table class="invoice-table table-sm table-bordered">
                ...
                <tr>
                  ...
                  <th colspan="2" scope="col">Акцизный налог, уплачиваемый при<br> реализации конечнему потребителю<br> бензина, дизельного топлива и газа</th>
                  <th rowspan="2" scope="col">тоимость поставки с учётом акцизного<br> налога уплачиваемого при реализации<br> конечному потребителю бензина,<br> дизельного топлива и газа</th>
                ...
                <tr>
                  ...
                  <td>
                    <b-form-input style="width: 90%" class="form-control text-right float-left"></b-form-input>
                    <span class="pt-1 float-right">%</span>
                  </td>
                  <td class="text-center"></td>
                  <td>
                    <b-form-input style="width: 90%" class="form-control text-right float-left"></b-form-input>
                  ...
                  <td class="text-center"></td>
                  <td class="text-center"></td>
                  <td class="text-center text-danger"><b class="cursor-pointer">x</b></td>
                </tr>
                <tr>
              ...
              <div class="pt-2 cursor-pointer">Добавить ещё</div>
            </b-row>
          </b-container>
          <hr>
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td class="pt-2 pl-2 text-right">
                      <b-form-input placeholder="Номер" style="max-width: 160px; margin-right: 20px" class="float-left"
                                    size="sm"></b-form-input>
                      <b-form-input placeholder="Дата" style="max-width: 105px;" class="float-left" size="sm"></b-form-input>
                    </td>
                  </tr>
                  </tbody>
                </table>
          ...
          <div class="text-right mt-5 mb-2">
            <b-button size="sm" variant="outline-success">Создать документ</b-button>
          </div>
        </div>
      </div>
    </div>
